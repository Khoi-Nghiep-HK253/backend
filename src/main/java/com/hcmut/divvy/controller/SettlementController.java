...
public class SettlementController {
         ...
         * {@code amount} must be greater than zero and must not exceed
         * {@code debt.amount}.
         * After the settlement is persisted, the debt status automatically transitions
         * to {@code SETTLED}.
         * <p>
         * Optional fields:
         * <ul>
         * <li>{@code method} — payment method (defaults to {@code "CASH"}).</li>
         * <li>{@code paidAt} — timestamp of the payment (defaults to the current
         * time).</li>
         * <li>{@code note} — free-text note.</li>
         * </ul>
         *
         * @param groupId        the group's ID
         * @param request        settlement payload (debtId, amount, method, note,
         *                       paidAt)
         * @param authentication the currently authenticated user (must be fromUser or
         *                       toUser of the debt)
        ...
        public ResponseEntity<ApiResponse<SettlementDetailResponse>> getSettlementById(
                        ...
                        Authentication authentication) {
                GetSettlementByIdModel model = settlementMapper.toGetSettlementByIdModel(groupId, settlementId,

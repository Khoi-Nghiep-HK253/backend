...
public class ExpenseController {
         ...
         * <li>Calculates the share amounts according to {@code splitType} and saves
         * {@code ExpenseShare}.</li>
         * <li>Computes net balances and saves {@code Debt} records using a Two-Pointer
         * Greedy algorithm.</li>
         * </ol>
         * Supported split types: {@code EQUAL}, {@code EXACT}, {@code PERCENTAGE},
         * {@code SHARES}, {@code ADJUSTMENT}.
         *
         * @param groupId        the group's ID
         * @param request        expense payload (description, totalAmount, currencyId,
         *                       splitType, payers, shares, ...)
         * @param authentication the currently authenticated user (must be a group
         *                       member)
         * @return {@code 201 Created} with the full ExpenseResponse (expense + payers +
         *         shares + debts);
         *         {@code 403} if the caller is not a member; {@code 400} if payer or
         *         share data is invalid
         */
        @PostMapping
        ...
        /**
         * Retrieve a paginated list of expenses for a group, with optional date range
         * filters.
         * <p>
        ...
        public ResponseEntity<ApiResponse<Page<ExpenseSummaryResponse>>> getGroupExpenses(
                ...
                Pageable pageable = PageRequest.of(page, size,
                                Sort.by(Sort.Direction.DESC, "expenseDate", "createdAt"));
         ...
         * <p>
         * Includes the list of payers, participant shares, and debts generated by this
         * expense.
         *
         * @param groupId        the group's ID
         ...
         *         {@code 404} if the expense does not exist; {@code 403} if the caller
         *         is not a member
         */
        ...
        public ResponseEntity<ApiResponse<ExpenseResponse>> getExpenseById(
                        ...
                        Authentication authentication) {
                GetExpenseByIdModel model = expenseMapper.toGetExpenseByIdModel(groupId, expenseId,
         ...
         * Cannot update an expense if any of its debts have already been settled
         * ({@code SETTLED}).
         * On success, all existing Payers, Shares, and Debts are deleted and recreated
         * from scratch.
         *
         * @param groupId        the group's ID
         * @param expenseId      the expense's ID
         ...
         * <p>
         * Authorized callers: the expense creator or an {@code OWNER} of the group.
         * Cannot delete an expense if any of its debts have already been settled
         * ({@code SETTLED}).
        ...
        public ResponseEntity<ApiResponse<Void>> deleteExpense(
                        ...
                        @PathVariable Integer expenseId,
                        Authentication authentication) {
                DeleteExpenseModel model = expenseMapper.toDeleteExpenseModel(groupId, expenseId,
                                authentication.getName());

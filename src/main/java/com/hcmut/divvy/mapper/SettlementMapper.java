...
public interface SettlementMapper {
        ...
        default GetGroupSettlementsModel toGetGroupSettlementsModel(Integer groupId, String currentUsername,
                        Integer fromUserId, Integer toUserId, LocalDate fromDate, LocalDate toDate, Pageable pageable) {
        ...
        default GetSettlementByIdModel toGetSettlementByIdModel(Integer groupId, Integer settlementId,
        ...
        default SettlementResponse toSettlementResponse(Settlement settlement, Debt debt) {
                ...
                return SettlementResponse.builder()
                                ...
                                .debt(SettlementResponse.DebtStatusInfo.builder()
                                                ...
                                                .newStatus(debt != null && debt.getStatus() != null
                                                                ? debt.getStatus().name()
                                                                : null)
                                                .build())
        ...
        default SettlementDetailResponse toSettlementDetailResponse(Settlement settlement) {
                ...
                return SettlementDetailResponse.builder()
                                ...
                                .debt(SettlementDetailResponse.DebtInfo.builder()
                                                ...
                                                .amount(settlement.getDebt() != null ? settlement.getDebt().getAmount()
                                                                : null)
                                                .build())
